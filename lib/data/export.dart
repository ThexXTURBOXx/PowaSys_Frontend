...
void showExportDialog(BuildContext context, DataState state) {
  ...
  final startController =
      TextEditingController(text: startDateExport.toIso8601String());
  final endController =
      TextEditingController(text: endDateExport.toIso8601String());
  showDialog(
    context: context,
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                ...
                onPressed: () => showFullDatePicker(
                  ...
                  if (date != null) {
                    startController.text = date.atStartOfDay.toIso8601String();
                  }
                }),
              ),
            ),
